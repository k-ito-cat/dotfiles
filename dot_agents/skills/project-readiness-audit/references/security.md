...
PJ 固有の認証方式、権限モデル、Cookie 属性、監査ログの保持期間、脆弱性報告窓口、SLA、開示ポリシーは `docs/specs/security.md` に残す。
...
- `docs/specs/security.md`, `legal.md`, `dependencies.md`, `operations.md`, `observability.md`
...
- 必要な場合、`docs/specs/security.md` に受付窓口、security.txt、SLA、報奨金有無、開示ポリシー、初動確認者があるか。
